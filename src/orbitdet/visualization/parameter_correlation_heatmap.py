...
class ParameterCorrelationHeatmap(Plot):
    """Plot a heatmap of the estimated parameter correlations from the estimation output."""

    def __init__(self, cfg, estimation_output: est_an.EstimationOutput):
        super().__init__(cfg)
